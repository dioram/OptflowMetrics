...
foreach(search ${_TensorRT_SEARCHES})
  find_path(TensorRT_RUNTIME_DIR NAMES nvinfer.dll ${${search}} PATH_SUFFIXES lib bin)
endforeach()
...
if(TensorRT_FOUND)
  ...
  if(NOT TensorRT_RUNTIME_LIBRARIES)
    file(GLOB TensorRT_RUNTIME_LIBRARIES ${TensorRT_RUNTIME_DIR}/*.dll)
  endif()
